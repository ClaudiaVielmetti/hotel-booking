...
//this is to make each hotel rooms dynamic - if hotel is selected the rooms available will show
					...
					<div class="room-wrap d-md-flex">
						...
						<div class="half left-arrow d-flex align-items-center">
							<div class="text p-4 p-xl-5 text-center">
								...
								<p class="mb-0"><span class="price mr-1">R<?php echo $room->price; ?></span> <span class="per">per night</span></p>
								...
								<ul class="list-accomodation">
									...
									<li><span>Size:</span> <?php echo $room->size; ?> 2</li>
